  ...
  return (
    <Timeline align="alternate">
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Paper elevation={3} className={classes.paper}>
            ...
            <Typography>Dans différentes société privée dernièrement chez RVF Sécurité pendant 3 ans assurant des missions dans la Gironde.</Typography>
          </Paper>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
      ...
      <TimelineOppositeContent>
        <Typography variant="body1" color="textPrimary">
            De 2007 à 2012
            <p>A Monaco, Londres, Val Louron dans les Pyrénées et en Gironde.</p>
          </Typography>
        </TimelineOppositeContent>
        <TimelineSeparator>
          <TimelineDot variant="outlined">
